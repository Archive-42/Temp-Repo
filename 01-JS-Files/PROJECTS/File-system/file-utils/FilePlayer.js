  ...
  function FilePlayer() {
    ...
    _defineProperty(
      ...
      function (e) {
        if (
          _this.player &&
          (0, _utils.supportsWebKitPresentationMode)(_this.player)
        ) {
  ...
  _createClass(FilePlayer, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (
          ...
          !(0, _utils.isMediaStream)(this.props.url)
        ) {
    ...
    },
    {
      ...
      value: function shouldUseAudio(props) {
        ...
        return (
          _patterns.AUDIO_EXTENSIONS.test(props.url) || props.config.forceAudio
        );
      },
    },
    {
      ...
      value: function shouldUseHLS(url) {
        ...
        return (
          _patterns.HLS_EXTENSIONS.test(url) ||
          MATCH_CLOUDFLARE_STREAM.test(url)
        );
      },
    },
    {
