...
```bash
npm install @stdlib/assert-has-tostringtag-support
```
...
```bash
npm install -g @stdlib/assert-has-tostringtag-support
```
...
[test-image]: https://github.com/stdlib-js/assert-has-tostringtag-support/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-has-tostringtag-support/actions/workflows/test.yml
