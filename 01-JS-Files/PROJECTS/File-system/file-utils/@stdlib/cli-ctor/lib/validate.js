...
function validate(opts, options) {
  if (typeof options !== "object" || options === null || isArray(options)) {
    return new TypeError(
      "invalid argument. Options must be an object. Value: `" + options + "`."
    );
  }
  if (hasOwnProp.call(options, "pkg")) {
    opts.pkg = options.pkg;
    if (
      typeof opts.pkg !== "object" ||
      opts.pkg === null ||
      isArray(opts.pkg)
    ) {
      return new TypeError(
        "invalid option. `pkg` option must be an object. Option: `" +
          opts.pkg +
          "`."
      );
    }
  ...
  if (hasOwnProp.call(options, "help")) {
    ...
    if (typeof opts.help !== "string") {
      return new TypeError(
        "invalid option. `help` option must be a string primitive. Option: `" +
          opts.help +
          "`."
      );
    }
  ...
  if (hasOwnProp.call(options, "version")) {
    ...
    if (typeof opts.version !== "string") {
      return new TypeError(
        "invalid option. `version` option must be a string primitive. Option: `" +
          opts.version +
          "`."
      );
    }
  ...
  if (hasOwnProp.call(options, "title")) {
    ...
    if (typeof opts.title !== "string" && typeof opts.title !== "boolean") {
      return new TypeError(
        "invalid option. `title` option must be either a string or boolean primitive. Option: `" +
          opts.title +
          "`."
      );
    }
  ...
  if (hasOwnProp.call(options, "updates")) {
    ...
    if (typeof opts.updates !== "boolean") {
      return new TypeError(
        "invalid option. `updates` option must be a boolean primitive. Option: `" +
          opts.updates +
          "`."
      );
    }
  ...
  if (hasOwnProp.call(options, "argv")) {
    ...
    if (!isArray(opts.argv)) {
      return new TypeError(
        "invalid option. `argv` option must be an array. Option: `" +
          opts.argv +
          "`."
      );
    }
  ...
  if (hasOwnProp.call(options, "options")) {
    ...
    if (
      typeof opts.options !== "object" ||
      opts.options === null ||
      isArray(opts.options)
    ) {
      return new TypeError(
        "invalid option. `options` option must be a plain object. Option: `" +
          opts.options +
          "`."
      );
    }
