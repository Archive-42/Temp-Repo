...
exports["lang:cv"] = {
  ...
  parse: function (test) {
    ...
    var tests =
        "кăрлач кăр_нарăс нар_пуш пуш_ака ака_май май_çĕртме çĕр_утă утă_çурла çур_авăн ав_юпа юпа_чӳк чӳк_раштав раш".split(
          "_"
        ),
      i;
  ...
  format: function (test) {
    ...
    var a = [
        [
          ...
          "вырсарникун, нарăс 14-мĕш 2010, 3:25:50 pm",
        ],
        ["ddd, hA", "выр, 3PM"],
  ...
  "format week": function (test) {
    ...
    var expected =
        "вырсарникун выр вр_тунтикун тун тн_ытларикун ытл ыт_юнкун юн юн_кĕçнерникун кĕç кç_эрнекун эрн эр_шăматкун шăм шм".split(
          "_"
        ),
      i;
    for (i = 0; i < expected.length; i++) {
  ...
  "calendar next week": function (test) {
    ...
    for (i = 2; i < 7; i++) {
      ...
      test.equal(
        m.calendar(),
        m.format("[Çитес] dddd LT [сехетре]"),
  ...
  "calendar last week": function (test) {
    ...
    for (i = 2; i < 7; i++) {
      ...
      test.equal(
        m.calendar(),
        m.format("[Иртнĕ] dddd LT [сехетре]"),
        "Today - " + i + " days current time"
      );
      m.hours(0).minutes(0).seconds(0).milliseconds(0);
      test.equal(
