...
exports["lang:nb"] = {
  ...
  parse: function (test) {
    ...
    var tests =
        "januar jan_februar feb_mars mars_april april_mai mai_juni juni_juli juli_august aug_september sep_oktober okt_november nov_desember des".split(
          "_"
        ),
      i;
  ...
  "format month": function (test) {
    ...
    var expected =
        "januar jan._februar feb._mars mars_april april_mai mai_juni juni_juli juli_august aug._september sep._oktober okt._november nov._desember des.".split(
          "_"
        ),
      i;
