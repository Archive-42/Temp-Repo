...
exports["lang:de"] = {
  ...
  parse: function (test) {
    ...
    var tests =
        "Januar Jan._Februar Febr._März Mrz._April Apr._Mai Mai_Juni Jun._Juli Jul._August Aug._September Sept._Oktober Okt._November Nov._Dezember Dez.".split(
          "_"
        ),
      i;
  ...
  "format week": function (test) {
    ...
    var expected =
        "Sonntag So. So_Montag Mo. Mo_Dienstag Di. Di_Mittwoch Mi. Mi_Donnerstag Do. Do_Freitag Fr. Fr_Samstag Sa. Sa".split(
          "_"
        ),
      i;
    for (i = 0; i < expected.length; i++) {
