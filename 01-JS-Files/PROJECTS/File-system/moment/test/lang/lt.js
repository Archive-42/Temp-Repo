...
exports["lang:lt"] = {
  ...
  parse: function (test) {
    ...
    var tests =
        "sausio sau_vasario vas_kovo kov_balandžio bal_gegužės geg_biržėlio bir_liepos lie_rugpjūčio rgp_rugsėjo rgs_spalio spa_lapkričio lap_gruodžio grd".split(
          "_"
        ),
      i;
