...
exports["lang:ka"] = {
  ...
  "format ordinal": function (test) {
    ...
    test.equal(
      moment("2011 100", "YYYY DDD").format("DDDo"),
      "მე-100",
      "მე-100"
    );
  ...
  "weeks year starting monday": function (test) {
    ...
    test.equal(
      ...
      2,
      "იან 14 2007 უნდა იყოს კვირა 2"
    );
    test.equal(
      moment([2007, 0, 15]).week(),
      3,
      "იან 15 2007 უნდა იყოს კვირა 3"
    );
  ...
  "weeks year starting tuesday": function (test) {
    ...
    test.equal(
      ...
      2,
      "იან 13 2008 უნდა იყოს კვირა 2"
    );
    test.equal(
      moment([2008, 0, 14]).week(),
      3,
      "იან 14 2008 უნდა იყოს კვირა 3"
    );
  ...
  "weeks year starting wednesday": function (test) {
    ...
    test.equal(
      ...
      2,
      "იან 12 2003 უნდა იყოს კვირა 2"
    );
    test.equal(
      moment([2003, 0, 13]).week(),
      3,
      "იან 13 2003 უნდა იყოს კვირა 3"
    );
  ...
  "weeks year starting thursday": function (test) {
    ...
    test.equal(
      ...
      2,
      "იან 11 2009 უნდა იყოს კვირა 2"
    );
    test.equal(
      moment([2009, 0, 12]).week(),
      3,
      "იან 12 2009 უნდა იყოს კვირა 3"
    );
  ...
  "weeks year starting friday": function (test) {
    ...
    test.equal(
      ...
      2,
      "იან 10 2010 უნდა იყოს კვირა 2"
    );
    test.equal(
      moment([2010, 0, 11]).week(),
      3,
      "იან 11 2010 უნდა იყოს კვირა 3"
    );
