...
exports["lang:ar"] = {
  ...
  parse: function (test) {
    test.expect(96);
    var tests =
        "يناير/ كانون الثاني:يناير/ كانون الثاني_فبراير/ شباط:فبراير/ شباط_مارس/ آذار:مارس/ آذار_أبريل/ نيسان:أبريل/ نيسان_مايو/ أيار:مايو/ أيار_يونيو/ حزيران:يونيو/ حزيران_يوليو/ تموز:يوليو/ تموز_أغسطس/ آب:أغسطس/ آب_سبتمبر/ أيلول:سبتمبر/ أيلول_أكتوبر/ تشرين الأول:أكتوبر/ تشرين الأول_نوفمبر/ تشرين الثاني:نوفمبر/ تشرين الثاني_ديسمبر/ كانون الأول:ديسمبر/ كانون الأول".split(
          "_"
        ),
      i;
  ...
  format: function (test) {
    ...
    var a = [
        [
          ...
          "الأحد, فبراير/ شباط 14 2010, 3:25:50 pm",
        ],
        ["ddd, hA", "الأحد, 3PM"],
  ...
  "format week": function (test) {
    ...
    var expected =
        "الأحد الأحد ح_الإثنين الإثنين ن_الثلاثاء الثلاثاء ث_الأربعاء الأربعاء ر_الخميس الخميس خ_الجمعة الجمعة ج_السبت السبت س".split(
          "_"
        ),
      i;
    for (i = 0; i < expected.length; i++) {
  ...
  "calendar day": function (test) {
    ...
    test.equal(
      ...
      "اليوم على الساعة 02:25",
      "Now plus 25 min"
    );
    test.equal(
      moment(a).add({ h: 1 }).calendar(),
      "اليوم على الساعة 03:00",
      "Now plus 1 hour"
    );
    test.equal(
      moment(a).add({ d: 1 }).calendar(),
      "غدا على الساعة 02:00",
      "tomorrow at the same time"
    );
    test.equal(
      moment(a).subtract({ h: 1 }).calendar(),
      "اليوم على الساعة 01:00",
      "Now minus 1 hour"
    );
    test.equal(
      moment(a).subtract({ d: 1 }).calendar(),
      "أمس على الساعة 02:00",
