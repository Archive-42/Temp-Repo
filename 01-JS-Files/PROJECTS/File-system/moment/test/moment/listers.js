...
exports.listers = {
  ...
  default: function (test) {
    ...
    test.deepEqual(moment.monthsShort(), [
      "Jan",
      "Feb",
      "Mar",
      "Apr",
    ...
    test.deepEqual(moment.weekdays(), [
      "Sunday",
      "Monday",
      "Tuesday",
      "Wednesday",
    ...
    test.deepEqual(moment.weekdaysShort(), [
      "Sun",
      "Mon",
      "Tue",
      "Wed",
    ...
    test.deepEqual(moment.weekdaysMin(), [
      "Su",
      "Mo",
      "Tu",
      "We",
