...
exports.duration = {
  ...
  "instatiation from serialized C# TimeSpan without days": function (test) {
    ...
    test.equal(
      moment.duration("500:59:59.9999999").days(),
      20,
      "500 hours overflows to 20 days"
    );
    test.equal(
      moment.duration("500:59:59.9999999").hours(),
      20,
  ...
  "instatiation from serialized C# TimeSpan without days or milliseconds":
    function (test) {
      test.expect(6);
  ...
  "instatiation from serialized C# TimeSpan without milliseconds": function (
    test
  ) {
    test.expect(6);
  ...
  "instatiation from serialized C# TimeSpan maxValue": function (test) {
    test.expect(6);
    test.equal(
      moment.duration("10675199.02:48:05.4775807").years(),
      29653,
      "29653 years"
    );
    test.equal(
      moment.duration("10675199.02:48:05.4775807").days(),
      29,
      "29 day"
    );
    test.equal(
      moment.duration("10675199.02:48:05.4775807").hours(),
      2,
      "2 hours"
    );
    test.equal(
      moment.duration("10675199.02:48:05.4775807").minutes(),
      48,
      "48 minutes"
    );
    test.equal(
      moment.duration("10675199.02:48:05.4775807").seconds(),
      5,
      "5 seconds"
    );
    test.equal(
      moment.duration("10675199.02:48:05.4775807").milliseconds(),
      477,
      "477 milliseconds"
    );
    test.done();
  ...
  "instatiation from serialized C# TimeSpan minValue": function (test) {
    test.expect(6);
    test.equal(
      moment.duration("-10675199.02:48:05.4775808").years(),
      -29653,
      "29653 years"
    );
    test.equal(
      moment.duration("-10675199.02:48:05.4775808").days(),
      -29,
      "29 day"
    );
    test.equal(
      moment.duration("-10675199.02:48:05.4775808").hours(),
      -2,
      "2 hours"
    );
    test.equal(
      moment.duration("-10675199.02:48:05.4775808").minutes(),
      -48,
      "48 minutes"
    );
    test.equal(
      moment.duration("-10675199.02:48:05.4775808").seconds(),
      -5,
      "5 seconds"
    );
    test.equal(
      moment.duration("-10675199.02:48:05.4775808").milliseconds(),
      -477,
      "477 milliseconds"
    );
    test.done();
  ...
  "serialization to ISO 8601 duration strings": function (test) {
    ...
    test.equal(
      moment.duration({ y: -0.5, M: 1 }).toIsoString(),
      "-P5M",
      "a month after half a year ago"
    );
  ...
  "ISO 8601 misuse cases": function (test) {
    ...
    test.equal(
      moment.duration("P-1DS").asSeconds(),
      0,
  ...
  humanize: function (test) {
    ...
    test.equal(
      moment.duration({ days: 76 }).humanize(),
      "3 months",
      "76 days = 3 months"
    );
    test.equal(
