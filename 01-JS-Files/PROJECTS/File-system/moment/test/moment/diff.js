...
exports.diff = {
  ...
  "diff across DST": function (test) {
    ...
    equal(
      test,
      b.diff(a, "M", true),
      (12 - dst.diff) / 24 / daysInMonth,
      "month diff across DST"
    );
    equal(
      test,
      b.diff(a, "y", true),
      (12 - dst.diff) / 24 / daysInMonth / 12,
      "year diff across DST"
    );
  ...
  "month diffs": function (test) {
    ...
    equal(
      ...
      -1 + 2 / 30,
      "Jan 31 to Feb 29 should be 1 - (2 / 30) months"
    );
    equal(
      test,
      moment([2012, 0, 31]).diff([2012, 2, 1], "months", true),
      -2 + 30 / 31,
      "Jan 31 to Mar 1 should be 2 - (30 / 31) months"
    );
    equal(
      test,
      moment([2012, 0, 31]).diff([2012, 2, 1, 12], "months", true),
      -2 + 29.5 / 31,
      "Jan 31 to Mar 1 should be 2 - (29.5 / 31) months"
    );
    equal(
      test,
