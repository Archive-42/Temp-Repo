...
exports.is_valid = {
  ...
  "valid Unix timestamp": function (test) {
    ...
    test.equal(moment(1379066897.0, "X").isValid(), true, "number whole 2dp");
    test.equal(moment(1379066897.07, "X").isValid(), true, "number 2dp");
    test.equal(moment(1379066897.17, "X").isValid(), true, "number 2dp");
    test.equal(moment(1379066897.0, "X").isValid(), true, "number whole 3dp");
    ...
    test.equal(
      moment("1379066897.00", "X").isValid(),
      true,
      "string whole 2dp"
    );
