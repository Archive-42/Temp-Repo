  ...
  bb("Weeks", 6048e5),
    ...
    (function (a) {
      ...
      return a.lang("cv", {
        ...
        monthsShort: "кăр_нар_пуш_ака_май_çĕр_утă_çур_ав_юпа_чӳк_раш".split(
          "_"
        ),
        weekdays:
    ...
    (function (a) {
      ...
      return a.lang("ro", {
        ...
        monthsShort: "ian_feb_mar_apr_mai_iun_iul_aug_sep_oct_noi_dec".split(
          "_"
        ),
    ...
    (function (a) {
      ...
      function e(a, b) {
        var c = {
            nominative:
              "янв_фев_мар_апр_май_июнь_июль_авг_сен_окт_ноя_дек".split("_"),
            accusative:
              "янв_фев_мар_апр_мая_июня_июля_авг_сен_окт_ноя_дек".split("_"),
          },
          d = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/.test(b)
            ? "accusative"
            : "nominative";
      ...
      function f(a, b) {
        var c = {
          ...
          d = /\[ ?[Вв] ?(?:прошлую|следующую)? ?\] ?dddd/.test(b)
            ? "accusative"
            : "nominative";
        return c[d][a.day()];
      }
    ...
    (function (a) {
      ...
      return a.lang("sq", {
        ...
        weekdays:
          "E Diel_E Hënë_E Marte_E Mërkure_E Enjte_E Premte_E Shtunë".split(
            "_"
          ),
