...
(function (a) {
  ...
  function w(a) {
    ...
    a._a &&
      -2 === a._pf.overflow &&
      ((b =
        a._a[jb] < 0 || a._a[jb] > 11
          ? jb
          : a._a[kb] < 1 || a._a[kb] > t(a._a[ib], a._a[jb])
          ? kb
          : a._a[lb] < 0 || a._a[lb] > 23
          ? lb
          : a._a[mb] < 0 || a._a[mb] > 59
          ? mb
          : a._a[nb] < 0 || a._a[nb] > 59
          ? nb
          : a._a[ob] < 0 || a._a[ob] > 999
          ? ob
          : -1),
  ...
  function F(a, b) {
    return a.isValid()
      ? ((b = G(b, a.lang())), Vb[b] || (Vb[b] = E(b)), Vb[b](a))
      : a.lang().invalidDate();
  }
  function G(a, b) {
    function c(a) {
    ...
    for (d = G(a._f, g).match(vb) || [], b = 0; b < d.length; b++)
      (e = d[b]),
        ...
        c &&
          ...
          (j += c.length)),
        Yb[e]
          ? (c ? (a._pf.empty = !1) : a._pf.unusedTokens.push(e), J(e, c, a))
  ...
  function Z(a, b, c, d, e) {
    ...
    return (
      ...
      (g = 7 * (b - 1) + (c - e) + f + 1),
      { year: g > 0 ? a : a - 1, dayOfYear: g > 0 ? g : u(a - 1) + g }
    );
  }
  function $(a) {
    var b = a._i,
      c = a._f;
    return null === b
      ? db.invalid({ nullInput: !0 })
      : ("string" == typeof b && (a._i = b = C().preparse(b)),
        db.isMoment(b)
          ? ((a = i(b)), (a._d = new Date(+b._d)))
          : c
          ? m(c)
            ? Q(a)
            : N(a)
  ...
  function _(a, b) {
    db.fn[a] = db.fn[a + "s"] = function (a) {
      ...
      return null != a
        ? (this._d["set" + c + b](a), db.updateOffset(this), this)
        : this._d["get" + c + b]();
    };
  }
  function ab(a) {
  ...
  for (
    var db,
      ...
      Qb = /([\+\-]|\d\d)/gi,
      Rb = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"),
      Sb = {
        Milliseconds: 1,
        Seconds: 1e3,
        Minutes: 6e4,
      ...
      Vb = {},
      Wb = "DDD w W M D d".split(" "),
      Xb = "M D H h m s w W".split(" "),
      Yb = {
        M: function () {
          return this.month() + 1;
        },
  ...
  for (
    Yb.DDDD = c(Yb.DDD, 3),
      ...
      db.lang = function (a, b) {
        var c;
        return a
          ? (b ? A(y(a), b) : null === b ? (B(a), (a = "en")) : pb[a] || C(a),
      ...
      db.isMoment = function (a) {
        return (
          a instanceof f || (null != a && a.hasOwnProperty("_isAMomentObject"))
        );
      },
      ...
      h((db.fn = f.prototype), {
        ...
        toISOString: function () {
          ...
          return 0 < a.year() && a.year() <= 9999
            ? F(a, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
            : F(a, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]");
        },
        toArray: function () {
          var a = this;
          return [
        ...
        isDSTShifted: function () {
          return this._a
            ? this.isValid() &&
                o(
                  this._a,
                  (this._isUTC ? db.utc(this._a) : db(this._a)).toArray()
                ) > 0
            : !1;
        },
        ...
        add: function (a, b) {
          var c;
          return (
            (c = "string" == typeof a ? db.duration(+b, a) : db.duration(a, b)),
            l(this, c, 1),
            this
          );
        },
          ...
          return (
            ...
            "year" === b || "month" === b
              ? ((d = 432e5 * (this.daysInMonth() + f.daysInMonth())),
                ...
                (e +=
                  (this -
                    db(this).startOf("month") -
                    (f - db(f).startOf("month"))) /
                  d),
                (e -=
                  (6e4 *
                    (this.zone() -
                      db(this).startOf("month").zone() -
                      (f.zone() - db(f).startOf("month").zone()))) /
                  d),
                "year" === b && (e /= 12))
              : ((d = this - f),
                (e =
        ...
        day: function (a) {
          ...
          return null != a
            ? ((a = V(a, this.lang())), this.add({ d: a - b }))
            : b;
        },
        month: function (a) {
          var b,
        ...
        isSame: function (a, b) {
          return (
            (b = b || "ms"), +this.clone().startOf(b) === +z(a, this).startOf(b)
          );
        },
        min: function (a) {
        ...
        dayOfYear: function (a) {
          var b =
            hb((db(this).startOf("day") - db(this).startOf("year")) / 864e5) +
            1;
