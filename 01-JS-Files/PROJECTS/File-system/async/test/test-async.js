...
exports["auto removeListener has side effect on loop iterator"] = function (
  test
) {
  async.auto({
    task1: [
...
exports["forEachSeries"] = function (test) {
  ...
  async.forEachSeries(
    [1, 3, 2],
    forEachIterator.bind(this, args),
    function (err) {
...
exports["map"] = function (test) {
  ...
  async.map(
    [1, 3, 2],
    mapIterator.bind(this, call_order),
    function (err, results) {
      test.same(call_order, [1, 2, 3]);
...
exports["detect"] = function (test) {
  ...
  async.detect(
    [3, 2, 1],
    detectIterator.bind(this, call_order),
    function (result) {
      call_order.push("callback");
...
exports["noConflict - node only"] = function (test) {
  if (typeof process !== "undefined") {
    ...
    fs.readFile(filename, function (err, content) {
      ...
      var Script =
        process.binding("evals").Script || process.binding("evals").NodeScript;
...
exports["queue push without callback"] = function (test) {
  ...
  setTimeout(function () {
    test.same(call_order, ["process 2", "process 1", "process 4", "process 3"]);
    test.done();
  }, 800);
};
