/*global setTimeout: false, console: false */ (function () {
  var a = {},
    b = this,
    c = b.async;
  ...
  typeof process == "undefined" || !process.nextTick
    ...
    (a.forEachLimit = function (a, b, c, d) {
      ...
      (function h() {
        ...
        while (g < b && f < a.length)
          (f += 1),
            (g += 1),
            c(a[f - 1], function (b) {
              b
                ? (d(b), (d = function () {}))
                : ((e += 1), (g -= 1), e === a.length ? d() : h());
            });
      })();
    });
  var h = function (b) {
        ...
        f = {
            ...
            b.constructor !== Array && (b = [b]),
              d(b, function (b) {
                f.tasks.push({
                  ...
                  f.saturated && f.tasks.length == c && f.saturated(),
          ...
          process: function () {
            if (e < f.concurrency && f.tasks.length) {
              var a = f.tasks.shift();
              f.empty && f.tasks.length == 0 && f.empty(),
                (e += 1),
                b(a.data, function () {
                  (e -= 1),
                    a.callback && a.callback.apply(a, arguments),
                    f.drain && f.tasks.length + e == 0 && f.drain(),
                    f.process();
                });
            }
          },
